  ...
  return (
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4 sm:p-6">
      <div className="flex items-center space-x-2 mb-4 sm:mb-6">
        ...
        <h2 className="text-lg sm:text-xl font-semibold text-gray-800">Available Foods</h2>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-2">
          ...
          <button
            ...
            className="px-3 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors duration-200 text-sm"
          >
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2">
            {commonEuropeanFoods.map((food) => (
              <button
                ...
                className={`
                  px-2 py-2 text-xs sm:text-sm rounded-lg border transition-colors duration-200 text-left
